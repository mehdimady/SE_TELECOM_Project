              ...
              {{-- <form id="quickForm"> --}}
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('product_name','', ['class'=>'form-control', 'id'=>'exampleInputEmail1','placeholder'=> 'Entrez le nom du Produit'])}}
                  </div>
                  <div class="form-group">
                    {{-- <label for="exampleInputEmail1">Nom du Produit</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Entrer le Nom du Produit"> --}}
                    {{Form::label('','Description du produit', ['for'=>'exampleInputEmail1'])}}
                    {{Form::text('product_description','', ['class'=>'form-control', 'id'=>'exampleInputEmail1','placeholder'=> 'Entrez la description du Produit'])}}
                  </div>
                  <div class="form-group">
...
{{Form::text('product_price','',['class'=>'form-control','id'=>'exampleInputEmail1','placeholder'=> 'Entrez le prix du produit'])}}
...
{{Form::select('product_category', $categories , null, ['placeholder'=>'Choisir une Catégorie', 'class' => 'form-control select 2'])}}             
                  </div>
                  <div class="form-group">
                    {{-- <label>Catégorie du Produit</label>
                    <select class="form-control select2" style="width: 100%;">
...
{{Form::select('product_marque', $marques , null, ['placeholder'=>'Choisir une Marque', 'class' => 'form-control select 2'])}}             
                  </div>
