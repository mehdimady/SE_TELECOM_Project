              ...
              <form>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="description1" class="form-control" id="exampleInputEmail1" placeholder="Entrer la description du slider">
                  ...
                  <div class="form-group">
                   ...
                   <input type="text" name="description2" class="form-control" id="exampleInputEmail1" placeholder="Entrer la description du slider">
                  ...
                  <label for="exampleInputFile">Image du Slider</label>
